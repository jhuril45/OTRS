...
(function($) {
	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			if(settings.show_meridian){
				new_ele.append(
					"<div class='meridian'>" +
						...
						bottom_arrow_button +
					"</div>" +
					////Edit for Add OK Button Jhuril///
					"<div class='ok_btn_div'>" +
						"<div class='prev action-next' style='visibility:hidden'></div>" +
						"<div class='ok_btn'></div>" +
						"<div class='prev action-next' style='visibility:hidden'></div>" +
					"</div>" +
					"<div class='ok_btn_div'>" +
						"<div class='prev action-next' style='visibility:hidden'></div>" +
						"<div class='ok_btn'><button class='btn btn-lg btn-success float-center' id='ok_time_btn'>Ok</button></div>" +
						"<div class='prev action-next' style='visibility:hidden'></div>" +
					"</div>" +
					"<div class='ok_btn_div'>" +
						"<div class='prev action-next' style='visibility:hidden'></div>" +
			...
			$('#ok_time_btn').on("click", function(event) {				
				close_timepicki();
			});
			///Function for OK Button///
